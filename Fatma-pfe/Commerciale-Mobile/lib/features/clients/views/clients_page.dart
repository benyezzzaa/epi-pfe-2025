...
import 'package:pfe/features/clients/views/edit_client_dialog.dart';
...
final adresseController = TextEditingController();
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("👥 Mes Clients", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
