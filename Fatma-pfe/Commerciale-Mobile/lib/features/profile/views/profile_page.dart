      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // Nom et prénom
            Obx(() => Text(
              '${_profileController.prenom.value} ${_profileController.nom.value}',
              style: TextStyle(
                fontSize: 24,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('Nom', _profileController.nom.value, Icons.person, colorScheme),
            const SizedBox(height: 12),
            _buildInfoRow('Prénom', _profileController.prenom.value, Icons.person_outline, colorScheme),
            const SizedBox(height: 12),
            _buildInfoRow('Email', _profileController.email.value, Icons.email, colorScheme),
            const SizedBox(height: 12),
            _buildInfoRow('Téléphone', _profileController.tel.value, Icons.phone, colorScheme),
          ],
        ),
      ),
    );
