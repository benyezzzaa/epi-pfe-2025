...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Ben Salah' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateUserDto.prototype, "prenom", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'ali.bensalah@example.com' }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^(?:\+33|0)[1-9][\d\s\-\.]{8,}$/, {
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['commercial', 'admin', 'bo'], required: false }),
    (0, class_validator_1.IsEnum)(['commercial', 'admin', 'bo']),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
