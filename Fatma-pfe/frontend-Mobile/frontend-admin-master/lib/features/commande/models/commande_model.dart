class CommandeModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'prix_hors_taxe': prixHorsTaxe,
      'statut': statut,
      'client': {
        'nom': clientNom.split(' ').last,
        'prenom': clientNom.split(' ').first,
        'adresse': clientAdresse,
        'email': clientEmail,
        'telephone': clientTelephone,
      },
      'lignesCommande': lignes.map((ligne) => ligne.toJson()).toList(),
      'promotion': promotion,
    };
  }
}
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'produit': {
        ...
        'images': produitImage != null ? [produitImage] : [],
      },
    };
  }
}
