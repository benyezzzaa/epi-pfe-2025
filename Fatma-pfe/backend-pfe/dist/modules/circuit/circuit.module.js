...
exports.CircuitModule = CircuitModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([circuit_entity_1.Circuit, client_entity_1.Client, users_entity_1.User])],
        controllers: [circuit_controller_1.CircuitController],
        providers: [circuit_service_1.CircuitService],
    })
], CircuitModule);
